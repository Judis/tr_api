defmodule I18NAPIWeb.UserRoleView do
  ...
  def render("index.json", %{user_role: user_role}) do
    %{data: render_many(user_role, UserRoleView, "user_roles.json")}
  end

  def render("show.json", %{user_role: user_role}) do
    %{data: render_one(user_role, UserRoleView, "user_roles.json")}
  end

  def render("user_roles.json", %{user_role: user_role}) do
    %{
      id: user_role.id,
      role: user_role.role,
